...
import com.boot.ktn.mapper.auth.LoginResultMapper;
...
public class LoginResultService {
    ...
    public Map<String, Object> callLoginProcedure(String empNo, String ip) {
        ...
        try {
            ...
            String errorMsg = "프로시저 호출 중 오류가 발생했습니다. [프로시저명: {}], [입력값: empNo={}, ip={}, userConGb={}, userAgent={}], [에러메시지: {}]";
            logger.error(errorMsg,"loginResultProcedure", empNo, ip, userConGb, userAgent, e.getMessage(), e);
