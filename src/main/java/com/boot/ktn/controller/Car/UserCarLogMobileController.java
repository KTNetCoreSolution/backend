...
public class UserCarLogMobileController {
    ...
    @CommonApiResponses
    @PostMapping("/carLogList")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> carLogList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MCARLOGLIST";
        String jobGb = "GET";
        ...
        try {
            ...
            errorMessage = "/carLogList unescapedResultList = mapViewParamsUtil.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> logDetail(
        ...
        try {
            ...
            errorMessage = "/logDetail unescapedResultList = mapViewParamsUtil.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> carLogRequestList(
        ...
        String rptCd = "MCARLOGREQUESTLIST";
        String jobGb = "GET";
    ...
    //과태료 납부완료 처리
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> paymentTransaction(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MPAYMENTTRANSACTION";
        String jobGb = "SET";
        ...
        try {
            ...
            errorMessage = "/paymentTransaction unescapedResultList = mapViewParamsUtil.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
