...
public class UserCarLogController {
    ...
    @CommonApiResponses
    @PostMapping("/userClassList")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> userClassList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "USERCLASSLIST";
        String jobGb = "GET";
        ...
        try {
            ...
            errorMessage = "/userClassList unescapedResultList = mapViewParamsUtil.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
