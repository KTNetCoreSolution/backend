...
@RestController
@RequestMapping("${api.base.path}/carStat")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "모바일 > 운행일지", description = "운행일지를 관리하는 API")
public class CarStatController {
    private static final Logger logger = LoggerFactory.getLogger(CarStatController.class);
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> workPerformance(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "WORKPERFORMANCEINFO";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/carAllocationStsByOrg")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> carAllocationStsByOrg(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "CARALLOCATIONSTSBYORG";
        String jobGb = "GET";
