...
public class CarCodeInfoController {
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> codeInfoList(
        ...
        try {
            ...
            errorMessage = "/codeInfoList unescapedResultList = mapViewParamsUtil.processDynamicView(rptCd, params, empNo, jobGb);";
    ...
    @CommonApiResponses
    @PostMapping("/CarCodeImage")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> CarCodeImage(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "CARCODEIMAGEINFO";
        String jobGb = "GET";
        ...
        try {
            ...
            errorMessage = "/CarCodeImage unescapedResultList = mapViewProcessor.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
