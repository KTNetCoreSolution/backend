...
@RestController
@RequestMapping("${api.base.path}/carhist")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "기동장비정보 > 기동장비변경이력", description = "기동장비변경이력 API")
public class CarInfoListUpdateHistController {
    private static final Logger logger = LoggerFactory.getLogger(CarInfoListUpdateHistController.class);
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> updateList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "CARLISTINFOUPDATEHIST";
        String jobGb = "GET";
        ...
        try {
            ...
            errorMessage = "/listInfoHist unescapedResultList = mapViewProcessor.processDynamicView(rptCd, params, empNo, jobGb);";
