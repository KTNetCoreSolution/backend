...
public class FuelCardnfoListController {
    ...
    @CommonApiResponses
    @PostMapping("/FuelCardDetail")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> FuelCardDetail(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "FUELCARDDETAIL";
        String jobGb = "GET";
        ...
        try {
            ...
            errorMessage = "/FuelCardDetail unescapedResultList = mapViewProcessor.processDynamicView(rptCd, params, empNo, jobGb);";
            logger.error(this.getErrorMessage(), e.getMessage(), e);
            return responseEntityUtil.okBodyEntity(null, "01", e.getMessage());
        }
