...
@io.swagger.v3.oas.annotations.tags.Tag(name = "99.공통 > 엑셀업로드결과이력", description = "엑셀업로드 결과 이력을 조회하는 API")
public class ExcelUploadResultController {

    private static final Logger logger = LoggerFactory.getLogger(ExcelUploadResultController.class);
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> resultList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "EXCELUPLOADRESULT";
        String jobGb = "GET";
