package com.boot.ktn.controller.common;
...
@RestController
@RequestMapping("${api.base.path}/common/userinfo")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "0.공통관리 > 사용자정보", description = "사용자정보를 제공하는 API")
public class UserInfoController {
    ...
    @CommonApiResponses
    @PostMapping("/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> userInfoList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "USERINFO";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/orgList")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> userOrgInfoList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "USERORGINFO";
        String jobGb = "GET";
