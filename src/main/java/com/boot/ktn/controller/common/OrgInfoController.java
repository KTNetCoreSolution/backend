...
@RestController
@RequestMapping("${api.base.path}/common/orginfo")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "0.공통관리 > 사용자조직정보", description = "사용자조직정보를 제공하는 API")
public class OrgInfoController {
    ...
    @CommonApiResponses
    @PostMapping("/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> orgInfoList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "ORGINFO";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/ddllist")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> orgInfoDDLList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "ORGINFODDL";
        String jobGb = "GET";
