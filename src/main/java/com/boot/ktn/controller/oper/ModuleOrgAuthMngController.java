...
@RestController
@RequestMapping("${api.base.path}/oper/moduleorgauth")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "3.시스템관리 > 업무조직권한관리", description = "사용자나 조직에서 관리조직을 관리하는 API")
public class ModuleOrgAuthMngController {
    private static final Logger logger = LoggerFactory.getLogger(ModuleOrgAuthMngController.class);
    ...
    @CommonApiResponses
    @PostMapping("/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> orgMngList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MODULEORGAUTHINFO";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/save")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> orgMngSave(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "MODULEORGAUTHINFOTRAN";
        String jobGb = "SET";
