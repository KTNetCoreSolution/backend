...
@RestController
@RequestMapping("${api.base.path}/oper/standard")
@RequiredArgsConstructor
@io.swagger.v3.oas.annotations.tags.Tag(name = "3.시스템관리 > 표준활동분류관리", description = "표준활동 분류를 관리하는 API")
public class StandardActivityClassInfoMngController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityClassInfoMngController.class);
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> classMngList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYCLASSINFOMNG";
        String jobGb = "GET";
    ...
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> classMngSave(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYCLASSINFOMNGTRAN";
        String jobGb = "SET";
