...
@io.swagger.v3.oas.annotations.tags.Tag(name = "3.시스템관리 > 표준활동BIZ업무정보관리", description = "표준활동 BIZ 업무정보를 관리하는 API")
public class StandardActivityBizProcessMngController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityBizProcessMngController.class);
    ...
    @CommonApiResponses
    @PostMapping("/bizProcess/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> bizProcessMngList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYBIZPROCESSMNG";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/bizProcess/save")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> bizProcessMngSave(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYBIZPROCESSMNGTRAN";
        String jobGb = "SET";
