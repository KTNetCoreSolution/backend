...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 조직별현황", description = "조직별현황을 관리하는 API")
public class StandardActivityOrgStatisticController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityOrgStatisticController.class);
    ...
    @CommonApiResponses
    @PostMapping("/orgStatistic/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> orgStatisticList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYORGSTATISTIC";
        String jobGb = "GET";
