...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 팀별업무관리", description = "팀별업무를 관리하는 API")
public class StandardActivityWorkTeamController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityWorkTeamController.class);
    ...
    @CommonApiResponses
    @PostMapping("/teamJob/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> teamJobList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYWORKTEAM";
        String jobGb = "GET";
