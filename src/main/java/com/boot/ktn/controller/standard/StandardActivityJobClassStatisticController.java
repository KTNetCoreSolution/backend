...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 업무분류별통계", description = "조직별현황을 관리하는 API")
public class StandardActivityJobClassStatisticController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityJobClassStatisticController.class);
    ...
    @CommonApiResponses
    @PostMapping("/jobClassStatistic/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> jobClassStatistic(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYJOBCLASSSTATISTIC";
        String jobGb = "GET";
