...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 업무내역조회", description = "업무내역조회를 관리하는 API")
public class StandardActivityJobHistoryController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityJobHistoryController.class);
    ...
    @CommonApiResponses
    @PostMapping("/jobHistory/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> jobHistoryList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYJOBHISTORY";
        String jobGb = "GET";
