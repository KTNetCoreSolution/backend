...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 팀별입력현황", description = "팀별입력현황을 관리하는 API")
public class StandardActivityTeamInputStatisticController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityTeamInputStatisticController.class);
    ...
    @CommonApiResponses
    @PostMapping("/teamInputStatistic/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> teamInputStatisticList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYTEAMINPUTSTATISTIC";
        String jobGb = "GET";
