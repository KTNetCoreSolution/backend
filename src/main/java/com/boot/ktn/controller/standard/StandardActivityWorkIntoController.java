...
@io.swagger.v3.oas.annotations.tags.Tag(name = "4.표준활동 > 투입업무현황", description = "투입업무현황을 관리하는 API")
public class StandardActivityWorkIntoController {
    private static final Logger logger = LoggerFactory.getLogger(StandardActivityWorkIntoController.class);
    ...
    @CommonApiResponses
    @PostMapping("/intoList/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> intoList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "STANDARDACTIVITYWORKINTO";
        String jobGb = "GET";
