...
@io.swagger.v3.oas.annotations.tags.Tag(name = "5.렌탈관리 > 렌탈일괄관리", description = "렌탈일괄을 관리하는 API")
public class RentalBatchMngController {
    private static final Logger logger = LoggerFactory.getLogger(RentalBatchMngController.class);
    ...
    @CommonApiResponses
    @PostMapping("/batchMng/list")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> batchMngList(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "RENTALBATCHMNG";
        String jobGb = "GET";
    ...
    @CommonApiResponses
    @PostMapping("/batchMng/save")
    public ResponseEntity<ApiResponseDto<List<Map<String, Object>>>> batchMngSave(
            @RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest
    ) {
        String rptCd = "RENTALBATCHMNGTRAN";
        String jobGb = "SET";
