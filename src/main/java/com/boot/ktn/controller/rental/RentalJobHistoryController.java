...
@io.swagger.v3.oas.annotations.tags.Tag(name = "5.렌탈관리 > 업무내역조회", description = "업무내역을 관리하는 API")
public class RentalJobHistoryController {
    private static final Logger logger = LoggerFactory.getLogger(RentalJobHistoryController.class);
